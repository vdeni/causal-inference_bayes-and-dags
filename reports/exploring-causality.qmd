...
$\hat{y}^{c-DAG}$ predicted from the causal DAG should be very similar (or
...
//| label: fig-three-var-confounding-indep
...
So, again, we seem to be getting the same predictions. I feel like this,
actually, shouldn't be surprising --- all we did is fix the $X$ values to some
concrete $x$, but everything else remained the same.
