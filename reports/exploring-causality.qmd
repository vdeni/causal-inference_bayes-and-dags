...
Turing.@model function gen_model_y_xz_t(X,
                                        Y,
                                        Z)
    s ~ Turing.Exponential(1)
...
p_compare = StatsPlots.@df d_dag_bn #=
    =# StatsPlots.scatter(:Y_dag,
                          :Y_bn;
                          legend = false,
                          markercolor = :black,
                          markeralpha = 0.3,
                          markerstrokecolor = nothing,
                          xlabel = "DAG predicted",
                          ylabel = "Bayesian network predicted")

StatsPlots.plot!(p_compare,
                 x -> x;
                 linecolor = :red)
...
I'll try fitting another Bayesian network, this one a bit more degenerate:
