...
estimate the causal effect an intervention on $X$ (in our case $do(X = 6)$)
would have on $Y$, we have to adjust for $X$'s parent variable $Z$.
We can do that the same way as when we were calculating the true expected value:
