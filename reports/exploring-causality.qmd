...
and the natural direct and indirect effects. For the total effect, the model
...
have attained had $X$ had been 0.

TODO:dodaj graf

Let's code that into the model:
...
would have under $X = 6$. Therefore, we're working with this graph:

Let's try coding this into the model:
